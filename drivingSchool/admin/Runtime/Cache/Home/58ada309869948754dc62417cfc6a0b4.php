...
<table class="tablelist">
        <tr>
          <td rowspan="4" width="150"><img src="/Public/<?php  echo $arr['stu_photo']; ?>" width="100px" height="100px" alt="照片" /></td>
    ...
    <table class="tablelist">
        ...
        <tr>
            <td>已完成</td>
            <td><?php if ($progress['progress_isaccept']==1) { echo "已完成"; }else{echo "未完成";} ?></td>
            <td><?php if ($progress['test_one']==1) { echo "已完成"; }else{echo "未完成";} ?></td>
            <td><?php if ($progress['test_two']==1) { echo "已完成"; }else{echo "未完成";} ?></td>
            <td><?php if ($progress['test_threee']==1) { echo "已完成"; }else{echo "未完成";} ?></td>
            <td><?php if ($progress['test_four']==1) { echo "已完成"; }else{echo "未完成";} ?></td>
            <td><?php if ($progress['mylicense']==1) { echo "已完成"; }else{echo "未完成";} ?></td>
        </tr>
        </tbody>
    </table>
</div>
