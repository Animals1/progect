...
<div class="place">
    ...
    <div style="margin-left:25px;">
        <form action="/index.php/Home/Personal/creatething" method="post">
            <table class="imagetable">
                <tr>
                    <th>时间：</th>
                    <td><input class="laydate-icon" onclick="laydate()" name="start"></td>
                </tr>
                <tr>
                    <th>代办事项：</th>
                    <td>
                ...
                <tr>
                    <th></th>
                    <td><input type="submit" value="提交">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Home/Personal/waitthing" style=" text-decoration: none;"><input type="button" value="取消"></a></td>
                </tr>
            </table>
        </form>
    </div>
