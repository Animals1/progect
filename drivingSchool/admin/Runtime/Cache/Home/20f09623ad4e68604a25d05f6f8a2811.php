...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <form action="/index.php/Home/Finance/search2" method="post">
            <ul class="toolbar" style="margin-left: 180px;">
                <li>
                    学员<input style="margin-bottom:2px;margin-left: 10px; width: 100px;height: 20px;" type="text" name="staff_name">
                </li>
                <li>
                    编号<input style="margin-bottom:2px;margin-left: 10px; width: 100px;height: 20px;" type="text" name="staff_sn">
                </li>
                <li>
