...
<body>
  ...
  <div class="place">
    ...
    <form action="/progect/drivingSchool/index.php/Home/Staff/upload" enctype="multipart/form-data" method="post" >
    <ul class="forminfo">
    ...
    <li><label>籍贯：</label><select name="marriage" id="">
        <option value='1'>结婚</option>
        <option value='2'>未结婚</option>
    </select>
    </li>
