  ...
  <div class="place">
    ...
    <div style="display: block" id="list">
        ...
        <select name="drivingid" id="">
            <?php if(is_array($coach[0])): foreach($coach[0] as $key=>$coach_v): ?><option value="<?php echo ($coach_v["dirving_id"]); ?>"><?php echo ($coach_v["driving_name"]); ?></option><?php endforeach; endif; ?>
        </select>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
