...
<div class="rightinfo">
    ...
    <table class="imagetable" >
            ...
            <tr>
                ...
                <td>
                    <img style="width: 100px;height: 50px;" src="/Public/<?php echo $sel['stu_photo']; ?>">
                </td>
                <td>
                    <?php echo $sel['stu_time']; ?>
                </td>
                <td>
                    <?php echo $sel['money_name']; ?>
                </td>
                <td>
                    <?php echo $sel['charge_time']; ?>
                </td>
                <td>
                    <?php echo $sel['payment_name']; ?>
                </td>
                <td>
                    <?php echo $sel['charge_money']; ?>元
                </td>
            </tr>
        </table>
