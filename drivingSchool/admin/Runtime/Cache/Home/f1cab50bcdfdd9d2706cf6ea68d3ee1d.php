...
<div class="rightinfo">
    ...
    <form action="doadds" method="post">
        <table class="imagetable" >
            ...
            <tr>
                <th>费用发生日期:</th>
                <td>
                    <input class="laydate-icon" onclick="laydate()" name="arrears_time"><br /><br />
                </td>
            </tr>
            <tr>
                <th>欠费类型:</th>
            ...
            <tr>
                <th>欠费金额:</th>
                <td>
                    <input type="text" name="arrears_money">元
                </td>
            </tr>
            <tr>
                <th>状态:</th>
                <td>
                    <select name="status_id">
                        <option value="0">--请选择--</option>
                        <?php foreach($statu as $v4){?>
                        <option value="<?php echo $v4['status_id'];?>"><?php echo $v4['status_name'];?></option>
                        <?php }?>
                    </select>
                </td>
            </tr>
