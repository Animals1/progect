...
<script src="/drivingSchool/Public/admin/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#df7611; background-image:url(/drivingSchool/Public/admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    <span>驾校管理系统</span>    
    <ul>
    <li><a href="/drivingSchool/index.php/Home/Login/index">回首页</a></li>
    <li><a href="#">帮助</a></li>
    <li><a href="#">关于</a></li>
    </ul>    
    </div>
    ...
    <div class="loginbox">
    <form action="/drivingSchool/index.php/Home/Index/index" method="post" onsubmit="return funall();">
    <ul>
